...
#define MPU9250_I2C_ADDRESS 0x68         // This address is used by MPU9250 when AD0 pin is logic low
#define MPU9250_I2C_ADDRESS_ALT 0x69     // This address is used by MPU9250 when AD0 pin is logic high

// Reset value for all registers except
...
#define MPU9250_FIFO_ACCEL_EN (0x01 << 3)
#define MPU9250_FIFO_GYRO_X_EN (0x01 << 6)
#define MPU9250_FIFO_GYRO_Y_EN (0x01 << 5)
#define MPU9250_FIFO_GYRO_Z_EN (0x01 << 4)
