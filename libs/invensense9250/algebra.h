 ...
 *
 * This only effects the operation of algebra_invert_matrix,
 * algebra_invert_matrix_inplace, and algebra_lin_system_solve.
 *
 ...
 *
 * matrix_t 'points' is a tall matrix with 3 columns and at least 6 rows.
 ...
 * @return     Returns 0 on success or -1 on failure.
 */
    int algebra_fit_ellipsoid(matrix_t points, vector_t *center, vector_t *lengths);
