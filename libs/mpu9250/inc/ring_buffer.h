...
#define RC_RINGBUF_INITIALIZER \
	...
	/**
 * @brief      Returns an ringbuf_t struct which is completely zero'd out
 ...
 * be initialized with this before calling ringbuf_alloc.
 *
 * @return     empty and ready-to-allocate ringbuf_t
 */
 ...
 * -1.0f on error.
 */
	double ringbuf_get_value(ringbuf_t *buf, int position);
